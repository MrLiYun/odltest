 ...
 */
package org.opendaylight.northsix.cli.commands;
...
public class NorthsixCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(NorthsixCliTestCommand.class);
    protected final NorthsixCliCommands service;

    public NorthsixCliTestCommand(final NorthsixCliCommands service) {
